...
\lstinline{-!all_squares_checked [achieve]}.\index{goal}\index{goal!drop}\index{plan}  Goal drops can appear in the deeds of plans but can not\footnote{at least not at present.} be  used to trigger plans.\index{goal}\index{goal!drop}\index{Gwendolen} 
